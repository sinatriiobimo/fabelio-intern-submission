...
export default function Hero() {
    return (
        <section class="flex items-center hero">
            ...
            Rumahku,<br class="" />Surgaku
            </h1>
            <h2 class="px-8 text-gray-700 text-base md:px-0 md:text-lg my-6 tracking-wide">
            Kemudahan membeli furniture premium dengan harga terbaik  
                <br class="hidden lg:block" />Wujudkan surga di dalam rumah anda
            </h2>
            <div>
                <a
                href="#click-to-product"
                class="bg-yellow-400 text-black hover:bg-black hover:text-yellow-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200">Cari Furniture</a>
            </div>
            </div>
              ...
              <button
                ...
                <div class="absolute w-full h-full">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/YL2fvWC1AWs"
                    frameborder="0"
