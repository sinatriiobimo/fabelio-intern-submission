...
export default function Footer() {
    ...
    <section class="">
      <div class="border-t border-b border-gray-200 py-12 mt-16 px-4">
        <div class="w-36 flex m-auto mb-8">
          <img
          ...
          <div class="flex flex-wrap -mx-4 justify-center">
            <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
                <li>
                  <Link to="/" class="hover:underline py-1 block">Shipping</Link>
                </li>
                <li>
                  <Link to="/" class="hover:underline py-1 block">Refund</Link>
                </li>
                <li>
                  <Link to="/" class="hover:underline py-1 block">Promotion</Link>
                </li>
              </ul>
            </div>
            <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
                <li>
                  <Link to="/" class="hover:underline py-1 block">About</Link>
                </li>
                <li>
                  <Link to="/" class="hover:underline py-1 block">Career</Link>
                </li>
                <li>
                  <Link to="/" class="hover:underline py-1 block">Contact Us</Link>
                </li>
              </ul>
            </div>
            <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
                <li>
                  <Link to="/" class="hover:underline py-1 block"
                    >Terms & Conds</Link>
                </li>
                <li>
                  <Link to="/" class="hover:underline py-1 block"
            ...
            <div class="px-4 w-full md:w-3/12 mb-4 md:mb-0">
              ...
              <form action="#">
                <label class="relative w-full">
                  ...
                  />
                  <button class="bg-yellow-500 absolute rounded-xl right-0 p-3">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
      ...
      <p class="text-sm">
        2021 • All Rights Reserved Fabelio by Sinatrio Bimo
      </p>
    </footer>
    </section>
    )
