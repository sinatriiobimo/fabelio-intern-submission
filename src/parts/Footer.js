...
export default function Footer() {
    ...
    <section>
      <div className="border-t border-b border-gray-200 py-12 mt-16 px-4">
        <div className="w-36 flex m-auto mb-8">
          <img
            ...
            <div className="px-4 w-full md:w-3/12 mb-4 md:mb-0">
              ...
              <form action="#">
                <label className="relative w-full">
                  ...
                  />
                  <button className="bg-yellow-500 absolute rounded-xl right-0 p-3">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
      ...
      <p className="text-sm">
        2021 • All Rights Reserved Fabelio Internship Program by Sinatrio Bimo
      </p>
    </footer>
    </section>
    )
